...
static int yas_bma222_set_calibration(unsigned char*);
/* --------------------------------------------------------------------------- */
/*  Local functions                                                            */
/* --------------------------------------------------------------------------- */
...
static int yas_bma222_set_calibration(unsigned char* data_cal)
{
  // for debug
    signed char tmp;
...
int yas_bma222_get_offset_filt_x(unsigned char *offsetfilt)
{
    ...
    {
    	err = yas_bma222_read_reg(YAS_BMA222_OFFSET_FILT_X_REG, offsetfilt, 1);
    }
   	return err;
}
/* EasyCASE ) */
...
int yas_bma222_get_offset_filt_y(unsigned char *offsetfilt)
{
    ...
    {
    	err = yas_bma222_read_reg(YAS_BMA222_OFFSET_FILT_Y_REG, offsetfilt, 1);
    }
   	return err;
}
/* EasyCASE ) */
...
int yas_bma222_get_offset_filt_z(unsigned char *offsetfilt)
{
    ...
    {
    	err = yas_bma222_read_reg(YAS_BMA222_OFFSET_FILT_Z_REG, offsetfilt, 1);
    }
   	return err;
}
...
#endif
static int yas_set_calibration(unsigned char* data_cal)
{
    int err;
    // for debug
...
/*  Global function                                                            */
/* --------------------------------------------------------------------------- */
int yas_acc_driver_init(struct yas_acc_driver *driver)
{
    ...
    driver->init = yas_init;
    driver->term = yas_term;
    driver->get_delay = yas_get_delay;
    driver->set_delay = yas_set_delay;
    driver->get_offset = yas_get_offset;
    driver->set_offset = yas_set_offset;
    driver->get_enable = yas_get_enable;
    driver->set_enable = yas_set_enable;
    driver->get_filter = yas_get_filter;
    driver->set_filter = yas_set_filter;
    driver->get_filter_enable = yas_get_filter_enable;
    driver->set_filter_enable = yas_set_filter_enable;
    driver->get_position = yas_get_position;
    driver->set_position = yas_set_position;
    driver->measure = yas_measure;
    driver->set_calibration = yas_set_calibration;
#if DEBUG
    driver->get_register = yas_get_register;
#endif
    pcb = &cb;
